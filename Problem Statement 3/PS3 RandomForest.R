...
v <- data.frame(Train$TotalDuration, Train$No.Of.Trips, Train$Weather_Icon, Train$TotalTrips)
v <- setNames(v, c("Test.TotalDuration", "Test.No.Of.Trips", "Test.Weather_Icon", "Test.TotalTrips"))
...
save(classifier2, file = 'C:/Users/manis/Desktop/RF.rda')
